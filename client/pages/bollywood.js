...
export class Bollywood extends Component {
  ...
  componentDidMount() {
    this.getBollywoodList();
    this.getPage_title();
  }

  getPage_title() {
    fetch(`${process.env.PATH_URL}/id-page_title?_id=2`, {
      method: "GET",
      headers: {
  ...
  page_titleUpdate(e) {
    fetch(`${process.env.PATH_URL}/page_title?_id=2`, {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  getBollywoodList() {
    fetch(`${process.env.PATH_URL}/get-bollywood-list`, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  deleteBollywoodId(item, i) {
    var id = item._id;
    fetch(`${process.env.PATH_URL}/bollywoodDelete?_id=${id}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
                      ...
                      {this.state.usersArray.map((item, i) => (
                        <tr>
                          ...
                          <td className="cele-btn">
                            <a onClick={() => this.deleteBollywoodId(item, i)}>
                              <span>Remove</span>
                            </a>
                          </td>
                        </tr>
