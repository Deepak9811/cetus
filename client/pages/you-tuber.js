...
export class youTuber extends Component {
  constructor(props) {
    super(props);
  ...
  getPage_title() {
    fetch(`${process.env.PATH_URL}/id-page_title?_id=4`, {
      method: "GET",
      headers: {
  ...
  page_titleUpdate(e) {
    fetch(`${process.env.PATH_URL}/page_title?_id=4`, {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  getYouTubeList() {
    fetch(`${process.env.PATH_URL}/get-youTube-list`, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  youTubeDeleteId(item, i){
    var id = item._id;
    fetch(`${process.env.PATH_URL}/youTubeDelete?_id=${id}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
                  ...
                  {this.state.usersArray.map((item, i) => (
                        <tr>
                          ...
                          <td className="cele-btn">
                            <a onClick={()=> this.youTubeDeleteId(item, i)} > Remove</a>
                          </td>
