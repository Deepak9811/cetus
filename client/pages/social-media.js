...
export class social extends Component {
  ...
  getPage_title() {
    fetch(`${process.env.PATH_URL}/id-page_title?_id=5`, {
      method: "GET",
      headers: {
  ...
  page_titleUpdate(e) {
    fetch(`${process.env.PATH_URL}/page_title?_id=5`, {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  getSocialMediaList() {
    fetch(`${process.env.PATH_URL}/get-socialMedia-list`, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  socialMedianDeleteId(item, i) {
    var id = item._id;
    fetch(`${process.env.PATH_URL}/socialMediaDelete?_id=${id}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
      ...
      <Protected>
        ...
        <div className="mg_tp hgt_c">
          ...
          <div className="container-fluid">
            ...
            >
              <h2 className="wd-25 fl">{this.state.page_title}</h2>
              ...
              {!this.state.loader ? (
                this.state.usersArray =="not_exist" ? (
                  <p className="loader_in_option fl">No data found</p>
                ) : (
                      ...
                      {this.state.usersArray.map((item, i) => (
                        <tr>
                          ...
                          <td className="cele-btn">
                            <a
                              onClick={() => this.socialMedianDeleteId(item, i)}
                            >
                              {" "}
                              <span>Remove</span>
                            </a>
