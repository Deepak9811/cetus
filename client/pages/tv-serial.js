...
export class tvSerial extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.getTvSerialList();
    this.getPage_title();
  }

  getPage_title() {
    fetch(`${process.env.PATH_URL}/id-page_title?_id=3`, {
      method: "GET",
      headers: {
  ...
  page_titleUpdate(e) {
    fetch(`${process.env.PATH_URL}/page_title?_id=3`, {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  getTvSerialList() {
    fetch(`${process.env.PATH_URL}/get-tvSerial-list`, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
  ...
  deleteTVserialId(item, i) {
    var id = item._id;
    fetch(`${process.env.PATH_URL}/tvSeriesDelete?_id=${id}`, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "content-type": "application/json",
                      ...
                      {this.state.usersArray.map((item, i) => (
                        <tr>
                          ...
                          <td className="cele-btn">
                            <a onClick={() => this.deleteTVserialId(item, i)}>
